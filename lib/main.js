...
// private
	...
	// methods
		...
		* @param {number|Buffer|Array} start : start tags
		* @param {number|Buffer|Array} end : end tags
		* @param {boolean} singleTag : single tags (ack, nak, ...)
		* @returns {bool} Tags compatibility
		*/
		function _checkTagsCompatibility (start, end, singleTag) {
		...
		function _initData (options) {
			...
			const result = {
				...
				if ("undefined" !== typeof options) {
					...
					if ("object" !== typeof options) {
					...
					else if ("undefined" !== typeof options.wak && !_checkTagsValidity(options.wak)) {
						throw new Error("wak parameter sended is not a number, or an Array of numbers");
					}
						...
						result.wak = "undefined" !== typeof options.wak ? options.wak : null;
				...
				if (!_checkTagsCompatibility(
					result.start, result.end,
					null !== result.ack || null !== result.nak || null !== result.wak
				)) {

					throw new Error(
						"if you want use \"ack\", \"nak\" or \"wak\" tags, you have to use both \"start\" AND \"end\" tags (... or none)"
					);
