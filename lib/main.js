...
module.exports = class SplitFrames extends require("stream").Transform {
	...
	constructor (options) {
		...
		(0, console).log("constructor", "start", this.start, "end", this.end);
		// (0, console).log("constructor", "start", this.start, "end", this.end, "escapeWith", this.escapeWith, "escaped", this.escaped);
			...
			try {
				...
				// start & end
					...
					// start tag detected
						...
						(0, console).log("start tag detected at", startAt);
						...
						if (-1 >= endAt) {
							...
							(0, console).log("end tag not detected");
						...
						// end tag detected
							...
							(0, console).log("end tag detected at", endAt);
