...
// consts
	...
	const ALLOWED_OPTIONS = [ "start", "end", "escapeWith", "escaped", "specifics" ];
...
// private
	...
	// methods
		...
		*/
		function _checkTagsCompatibility (start, end, specificTag) {
			...
			const result = {
				...
				if ("undefined" !== typeof options) {
					...
					if ("object" !== typeof options) {
						...
						if ("undefined" !== typeof options.start && !_checkTagsValidity(options.start)) {
							throw new TypeError("start parameter sended is not a number, Buffer, or an Array of numbers");
						}
						else if ("undefined" !== typeof options.end && !_checkTagsValidity(options.end)) {
							throw new TypeError("end parameter sended is not a number, Buffer, or an Array of numbers");
						}
							...
							if ("object" === typeof options.specifics) {
								...
								Object.keys(options.specifics).forEach((key) => {
									...
									if ("undefined" !== typeof options.specifics[key]) {
										...
										else if (!_checkTagsCompatibility(result.start, result.end, options.specifics[key])) {

											throw new Error(
												"if you want use \"" + options.specifics[key] + "\" specifics option" +
												", you have to use both \"start\" AND \"end\" tags (... or none)"
											);
